...
//		new DetectFaceDemo().run();
		...
		// 比較画像01
		Mat image01 = Highgui.imread("./input/page.jpg"); // ←ここのファイルを書き換えればおｋ

		// 比較画像02
		Mat image02 = Highgui.imread("./input/icon.jpg"); // ←ここのファイルを書き換えればおｋ
		...
		// 出力画像 at SURF
		Highgui.imwrite("./output/descriptedImageBySURF-" + now + ".jpg", matchedImage);
	}
}
