...
import com.adv.img.main.AdvMain;
...
public class FileUploadController {
	...
	String uploadFileHandler(@RequestParam("name") String name,
		...
		if (!file.isEmpty()) {
			try {
				...
				File serverFile = new File(dir.getAbsolutePath() + File.separator + "main_image.png");				
				BufferedOutputStream stream = new BufferedOutputStream(new FileOutputStream(serverFile));
				stream.write(bytes);
				stream.close();

				AdvMain advm = new AdvMain();
				
				String message = advm.getCoords(name, serverFile.getAbsolutePath());
	...
	String uploadMultipleFileHandler(@RequestParam("mainimg") String mainimg,
		...
		message = main_path+"<br/><hr/>"+sub_path;
		
		AdvMain advm = new AdvMain();
		
		message +="<br/><hr/>"+advm.getCoords(sub_path, main_path);
